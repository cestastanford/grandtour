...
<a name="figure-1">
    <img id="fig1" class="fig" src="figure-1.svg" onclick="zoom(this, getElementById('fig2'), getElementById('cap12'))">
</a>
<br>
<br>
<a name="figure-2">
    <img id="fig2" class="fig" src="figure-2.svg" onclick="zoom(getElementById('fig1'), this, getElementById('cap12'))">
</a>
...
<a name="figure-3">
    <img class="fig" src="figure-3.svg" onclick="zoom(this, null, getElementById('cap3'))">
</a>
...
<figure>
<a name="figure-5b">
    <img class="fig" src="figure-5b.svg" onclick="zoom(this, null, getElementById('cap5'))">
</a>
...
<a name="figure-8">
    <img class="fig" src="figure-8.svg" onclick="zoom(this, null, getElementById('cap8'))">
</a>
