...
app.controller('ExploreCtrl', function($scope, $http, $location, $stateParams) {
	...
	var dimensionsArray = ['index', 'pursuits.pursuit'];
	var dimensions = {};
	var documents;
  ...
  //d3.csv("bower_components/elastic-list/nobel_prizes.csv", onDataLoaded);


  $http.get('/api/entries')
  .success(function(res){
    onDataLoaded(null, res.entries)
  });
