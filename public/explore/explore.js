...
export default ['$scope', '$http', '$location', '$stateParams', '$state', '$q', 'httpQuery', 'entryHighlightingService', function($scope, $http, $location, $stateParams, $state, $q, httpQuery, entryHighlightingService) {
  ...
  $scope.dimensions = [
    ...
    { type : 'facet', active : false, label : 'Occupations & Posts', description: '', field : 'occupations', suggestion: 'occupations.title', href: `${BOOK_URL}/presenting-the-data#paragraph-54` },
    ...
    { type : 'facet', active : true, label : 'Societies & Academies', description: '', field : 'societies', suggestion: 'societies.title', href: `${BOOK_URL}/presenting-the-data#paragraph-65` },
    { type : 'facet', active : false, label : 'Societies & Academies', subgroup: 'Role', description: '', field : 'societies_role', suggestion: 'societies.role', href: `${BOOK_URL}/presenting-the-data#paragraph-65` },
    { type : 'facet', active : true, label : 'Education', subgroup: 'Institution', description: '', field : 'education_institution', suggestion: 'education.institution', href: `${BOOK_URL}/presenting-the-data#paragraph-50` },
    { type : 'facet', active : false, label : 'Education', subgroup: 'Place', description: '', field : 'education_place', suggestion: 'education.place', href: `${BOOK_URL}/presenting-the-data#paragraph-50` },
    { type : 'facet', active : false, label : 'Education', subgroup: 'Teacher', description: '', field : 'education_teacher', suggestion: 'education.teacher', href: `${BOOK_URL}/presenting-the-data#paragraph-50` },
    { type : 'facet', active : false, label : 'Education', subgroup: 'Degree', description: '', field : 'education_degree', suggestion: 'education.fullDegree', href: `${BOOK_URL}/presenting-the-data#paragraph-50` },
    ...
    { type : 'facet', active : false, label : 'Exhibitions & Awards', subgroup: 'Institution', description: '', field : 'exhibitions', suggestion: 'exhibitions.title', href: `${BOOK_URL}/presenting-the-data#paragraph-69` },
    { type : 'facet', active : false, label : 'Exhibitions & Awards', subgroup: 'Award type', description: '', field : 'exhibitions_activity', suggestion: 'exhibitions.activity', href: `${BOOK_URL}/presenting-the-data#paragraph-69` },
