...
exports.getCounts = async revisionIndex => {
    ...
    if (!counts) {
        ...
        const countQueries = {
            ...
            travel_place: { 'travels.place': { $ne: null } },
            travel_date: { 'travels.travelStartYear': { $ne: null } },
            travel_year: { 'travels.travelStartYear': { $ne: null } },
            travel_month: { 'travels.travelStartMonth': { $ne: null } },
            travel_day: { 'travels.travelStartDay': { $ne: null } },
