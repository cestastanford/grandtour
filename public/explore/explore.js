...
export default ['$scope', '$http', '$location', '$stateParams', '$state', '$q', 'httpQuery', 'entryHighlightingService', function($scope, $http, $location, $stateParams, $state, $q, httpQuery, entryHighlightingService) {
  ...
  const BOOK_URL = process.env.BOOK_ORIGIN || "https://aworldmadebytravel.supdigital.org";

  $scope.dimensions = [
    { type : 'facet', active : false, label : 'Traveler name', description: 'The names of the 6007 travelers in the database, including alternate names. ', field : 'fullName', suggestion: 'fullName', sorting : 'fullName', href: `${BOOK_URL}/presenting-the-data#traveler-name` },
    ...
    { type : 'date', active : false, label : 'Birth date', description: '', field : 'birthDate', sorting : 'dates[0].birthDate', href: `${BOOK_URL}/presenting-the-data#birth-date` },
    { type : 'facet', active : false, label : 'Birth place', description: '', field : 'birthPlace', suggestion: 'places.birthPlace', sorting : 'places[0].birthPlace', href: `${BOOK_URL}/presenting-the-data#birth-place` },
    { type : 'date', active : false, label : 'Death date', description: '', field : 'deathDate', sorting : 'dates[0].deathDate', href: `${BOOK_URL}/presenting-the-data#death-date` },
    ...
    { type : 'facet', active : true, label : 'DBITI Employments & Identifiers', description: '', field : 'pursuits', suggestion: 'pursuits.pursuit', href: `${BOOK_URL}/presenting-the-data#paragraph-41` },
    ...
    { type : 'facet', active : true, label : 'Occupations & Posts', subgroup: 'Group', description: 'The eleven groupings into which occupations and posts are gathered thematically to facilitate interrogation of the data.', field : 'occupations_group', suggestion: 'occupations.group', href: `${BOOK_URL}/presenting-the-data#paragraph-47` },
    ...
    { type : 'facet', active : false, label : 'Societies & Academies', subgroup: 'Role', description: 'The role played by the travelers in the societies or academies to which they are affiliated in the database’s records.', field : 'societies_role', suggestion: 'societies.role', href: `${BOOK_URL}/presenting-the-data#paragraph-62` },
    ...
    { type : 'facet', active : false, label : 'Education', subgroup: 'Teacher', description: 'The ninety-six teachers recorded as educators for 104 travelers in the database (less than 2% of all travelers).', field : 'education_teacher', suggestion: 'education.teacher', href: `${BOOK_URL}/presenting-the-data#education` },
    { type : 'facet', active : false, label : 'Education', subgroup: 'Degree', description: 'The twelve types of degrees that are recorded for 126 travelers in the database (just over 2% of all travelers).', field : 'education_degree', suggestion: 'education.fullDegree', href: `${BOOK_URL}/presenting-the-data#education` },
    { type : 'facet', active : false, label : 'Military careers', description: '', field : 'military', suggestion: 'military.rank', href: `${BOOK_URL}/presenting-the-data#military-careers` },
    ...
    { type : 'facet', active : false, label : 'Mentioned names', description: '', field : 'mentionedNames', suggestion: 'mentionedNames.name', href: `${BOOK_URL}/presenting-the-data#mentioned-names` },
    { type : 'facet', active : false, label : 'Sources', description: '', field : 'sources', suggestion: 'sources.abbrev', href: `${BOOK_URL}/presenting-the-data#sources` },
    { type : 'facet', active : false, label : 'Travel place', description: '', field : 'travelPlace', suggestion: 'travels.place', href: `${BOOK_URL}/presenting-the-data#travel-place` },
    { type : 'date', active : false, label : 'Travel date', description: '', field : 'travelDate', href: `${BOOK_URL}/presenting-the-data#travel-date` },
