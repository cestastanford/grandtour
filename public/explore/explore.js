...
export default ['$scope', '$http', '$location', '$stateParams', '$state', '$q', 'httpQuery', 'entryHighlightingService', function($scope, $http, $location, $stateParams, $state, $q, httpQuery, entryHighlightingService) {
  ...
  $scope.dimensions = [
    ...
    { type : 'facet', active : true, label : 'DBITI Employments & Identifiers', description: '', field : 'pursuits', suggestion: 'pursuits.pursuit', href: `${BOOK_URL}/presenting-the-data#dbiti-employments-\&-identifiers` },
    ...
    { type : 'facet', active : true, label : 'Occupations & Posts', subgroup: 'Group', description: 'The eleven groupings into which occupations and posts are gathered thematically to facilitate interrogation of the data.', field : 'occupations_group', suggestion: 'occupations.group', href: `${BOOK_URL}/presenting-the-data#occupations-\&-posts` },
    { type : 'facet', active : true, label : 'Societies & Academies', description: 'The twenty-four cultural, scientific, and artistic associations for which there are records of affiliation in the database. For only 8.3% of the travelers there are such records.', field : 'societies', suggestion: 'societies.title', href: `${BOOK_URL}/presenting-the-data#societites-\&-academies` },
    { type : 'facet', active : false, label : 'Societies & Academies', subgroup: 'Role', description: 'The role played by the travelers in the societies or academies to which they are affiliated in the database’s records.', field : 'societies_role', suggestion: 'societies.role', href: `${BOOK_URL}/presenting-the-data#societites-\&-academies` },
