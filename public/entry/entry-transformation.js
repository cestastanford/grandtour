...
app.factory('entryTransformationService', function($http, entryHighlightingService, $timeout, $sce) {
    ...
    */
    ...
    var transformations = [
        ...
        transformUnformattedEntryText.bind(null, [ 'biography', 'tours', 'narrative', 'notes' ]),
        highlightEntryText.bind(null, [ 'biography', 'tours', 'narrative', 'notes' ]),
        superscript.bind(null, [ 'biography', 'tours', 'narrative' ]),
        linkFootnotes,
        trustFormattedEntryText.bind(null, [ 'biography', 'tours', 'narrative', 'notes' ]),
    ...
    */
    ...
    function downloadMentionedNames(entry) {
        ...
        Promise.all(entry.mentionedNames.map(function(name) {
    ...
    */
    ...
    function linkFootnotes(entry) {
        ...
        $http.get('/api/linked-footnotes/in-entry/' + entry.index)
        .then(function(response) {

            var notes = entry.notes_formatted
            ...
            if (linkedFootnotes.length) {
                ...
                entry.notes_formatted = linkedNotes
                $timeout(function() {
