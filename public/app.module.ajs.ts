...
.run(['$rootScope', '$state', '$stateParams', '$http', 
  function ($rootScope, $state, $stateParams, $http) {
    ...
    $rootScope.tutorialSteps = function() {
        return {
          'entry': [
            {src: 'tutorials/entry-1.png', prev: ['87%', '32%'], close: ['64%', '66%'], next: ['87%', '62.5%']},
            {src: 'tutorials/entry-2.png', prev: ['47%', '30.5%'], close: ['29.5%', '64.75%'], next: ['47%', '62.5%']},
            {src: 'tutorials/entry-3.png', prev: ['47%', '32%'], close: ['29.5%', '66%'], next: ['47%', '62.5%']},
            {src: 'tutorials/entry-4.png', prev: ['88%', '31%'], close: ['76%', '65%'], next: ['88%', '61.5%']},
            {src: 'tutorials/entry-5.png', prev: ['62%', '33.5%'], close: ['47.5%', '67.5%'], next: ['62%', '64.5%']},
            {src: 'tutorials/entry-6.png', prev: ['88%', '33.5%'], close: ['73.5%', '67.5%'], next: ['88%', '64.5%']},
            {src: 'tutorials/entry-7.png', prev: ['87%', '31%'], close: ['75%', '65%'], next: ['87%', '62%']},
            {src: 'tutorials/entry-8.png', prev: ['16.5%', '63%'], close: ['10.5%', '96.5%'], next: ['16.5%', '93%']},
          ],
          'map': [
            {src: 'tutorials/map-1.png', prev: ['82%', '32%'], close: ['70%', '66%'], next: ['82%', '62.5%']},
            {src: 'tutorials/map-2.png', prev: ['45%', '49.5%'], close: ['36%', '83.5%'], next: ['45%', '80%']},
            {src: 'tutorials/map-3.png', prev: ['28.5%', '62.5%'], close: ['19.5%', '96.5%'], next: ['28.5%', '93%']},
            {src: 'tutorials/map-4.png', prev: ['80%', '36%'], close: ['68.5%', '70.25%'], next: ['80%', '67%']},
            {src: 'tutorials/map-5.png', prev: ['16.5%', '62.5%'], close: ['10.5%', '96.5%'], next: ['16.5%', '93%']},
          ],
          'chart': [
            {src: 'tutorials/chart-1.png', prev: ['42%', '32%'], close: ['33.5%', '66%'], next: ['42%', '62.5%']},
            {src: 'tutorials/chart-2.png', prev: ['28%', '18.5%'], close: ['19.5%', '52.5%'], next: ['28%', '48.5%']},
            {src: 'tutorials/chart-3.png', prev: ['39.5%', '33.5%'], close: ['25.5%', '67.5%'], next: ['39.5%', '64%']},
            {src: 'tutorials/chart-4.png', prev: ['16.5%', '62.5%'], close: ['10.5%', '96.5%'], next: ['16.5%', '93%']},
          ],
          'search': [
            {src: 'tutorials/search-1.png', prev: ['49%', '22%'], close: ['37%', '55.75%'], next: ['49%', '52%']},
            {src: 'tutorials/search-2.png', prev: ['41.5%', '30%'], close: ['30%', '64.25%'], next: ['41.5%', '61%']},
            {src: 'tutorials/search-3.png', prev: ['61.5%', '33.5%'], close: ['50%', '67.5%'], next: ['61.5%', '64%']},
            {src: 'tutorials/search-4.png', prev: ['13.5%', '62.5%'], close: ['7.5%', '96.5%'], next: ['13.5%', '93%']},
          ],
          'explore': [
            {src: 'tutorials/explore-1.png', prev: ['43%', '10.3%'], close: ['31%', '44.5%'], next: ['43%', '41%']},
            {src: 'tutorials/explore-2.png', prev: ['24.5%', '26%'], close: ['10%', '59.5%'], next: ['24.5%', '58%']},
            {src: 'tutorials/explore-3.png', prev: ['28%', '42%'], close: ['13.5%', '75.75%'], next: ['28%', '72%']},
            {src: 'tutorials/explore-4.png', prev: ['24.5%', '58%'], close: ['13%', '91.5%'], next: ['24.5%', '88%']},
            {src: 'tutorials/explore-5.png', prev: ['41%', '32%'], close: ['18%', '66%'], next: ['41%', '62%']},
            {src: 'tutorials/explore-6.png', prev: ['17%', '62%'], close: ['8%', '96%'], next: ['17%', '92%']},
          ],
      }[$state.current.name] || [];
    }
